...
function CommentButton({ drugId, drugName }: { drugId: string; drugName: string }) {
                  ...
                  {catDrugs.map((drug) => (
                    <div key={drug.id} className="px-4 py-3">
                      <div className="flex items-start gap-2">
                        ...
                        {/* Actions: comment + favorite */}
                        <div className="flex flex-col items-center gap-2 flex-shrink-0 mt-0.5">
                          <CommentButton drugId={drug.id} drugName={drug.brandName} />
